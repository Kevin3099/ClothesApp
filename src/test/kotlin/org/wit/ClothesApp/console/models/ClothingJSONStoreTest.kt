...
class ClothingJSONStoreTest {
    ...
    fun findOne() {
        ...
        clothingStore.create(testing)
        assertEquals(clothingStore.findOne(clothingStore.clothing[clothingStore.clothing.size -1].id), clothingStore.clothing[clothingStore.clothing.size -1])
    }
    ...
    fun findByTitle() {
        ...
        clothingStore.create(testing)
        assertEquals(clothingStore.findByTitle(clothingStore.clothing[clothingStore.clothing.size -1].title)!!.title,testing.title)
    }
    ...
    fun update() {
        ...
        assertEquals(clothingStore.findOne(clothingStore.clothing[clothingStore.clothing.size -1].id)!!.title, "testing")
    }
